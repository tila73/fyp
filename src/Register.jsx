    ...
    <div className="h-screen flex flex-col items-center">
      ...
      <div className="border-gray-200 border-solid border-2 mt-5 sm:w-80 flex flex-col justify-center">
        ...
        >
          ...
          {server_error.name ? <p className="text-xs text-red-700 mb-1">{server_error.name[0]}</p> : ""}
          <div className="flex flex-col py-2">
            <label>Email</label>
            <input className="border p-2" name="email" type="email" />
          </div>
          {server_error.email ? <p className="text-xs text-red-700 mb-1">{server_error.email[0]}</p> : ""}
          <div className="flex flex-col py-2">
            <label>Address</label>
            <input className="border p-2" name="address" type="text" />
          </div>
          {server_error.address ? <p className="text-xs text-red-700 mb-1">{server_error.address[0]}</p> : ""}
          <div className="flex flex-col py-2">
            <label>Password</label>
            <input className="border p-2" name="password" type="password" />
          </div>
          {server_error.password ? <p className="text-xs text-red-700 mb-1">{server_error.password[0]}</p> : ""}
          <div className="flex flex-col py-2">
            <label>Confirm Password</label>
            <input className="border p-2" name="password2" type="password" />
          </div>
          {server_error.password2 ? <p className="text-xs text-red-700 mb-1">{server_error.password2[0]}</p> : ""}
